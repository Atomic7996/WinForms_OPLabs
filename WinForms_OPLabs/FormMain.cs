...
namespace WinForms_OPLabs
{
    public partial class FormMain : Form
    {
        ...
        private void LR8ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            FormLR8 lr = new FormLR8();
            lr.MdiParent = this;
            lr.Show();
        }

        private void LR9ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            FormLR9 lr = new FormLR9();
            lr.MdiParent = this;
            lr.Show();
        }
        ...
        private void lR11ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            FormLR12 lr = new FormLR12();
            lr.MdiParent = this;
            lr.Show();
        }
    }
